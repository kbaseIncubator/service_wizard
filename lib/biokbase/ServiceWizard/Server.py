...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ServiceWizard'):
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ServiceWizard'
        ...
        self.rpc_service.add(impl_ServiceWizard.start,
                             ...
                             types=[dict])
        self.method_authentication['ServiceWizard.start'] = 'none'
        self.rpc_service.add(impl_ServiceWizard.stop,
                             name='ServiceWizard.stop',
                             types=[dict])
        self.method_authentication['ServiceWizard.stop'] = 'none'
        self.rpc_service.add(impl_ServiceWizard.list_service_status,
                             name='ServiceWizard.list_service_status',
                             types=[dict])
        self.method_authentication['ServiceWizard.list_service_status'] = 'none'
        ...
        self.rpc_service.add(impl_ServiceWizard.get_service_status_without_restart,
                             ...
                             types=[dict])
        self.method_authentication['ServiceWizard.get_service_status_without_restart'] = 'none'
        self.rpc_service.add(impl_ServiceWizard.get_service_log,
